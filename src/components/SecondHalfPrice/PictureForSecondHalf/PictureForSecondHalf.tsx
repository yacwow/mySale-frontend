        ...
        <div style={{ position: 'relative' }} className={styles.container}>
            <a href={data.href} style={{ textDecoration: 'none' }}>
                <div style={{ position: 'relative' }}>
                    ...
                    {data.discount ? <LazyLoadImage src="/img/discount.jpg"
                        style={{ position: 'absolute', bottom: 0, right: 0, width: '30%' }} alt="" /> : null}
                    <LazyLoadImage src="/img/50%discount.webp"
                        alt="二つ目は半額です"
                        style={{ width: '30%', height: 'auto', position: 'absolute', zIndex: 2, top: 0, right: 0 }} />
                ...
                <div className={styles.bottom}>
                    ...
                    <div className={styles.second}>
                        <div>                    
                            <span  >¥</span>
                            <span style={{ fontSize: 21 }} >{NumToString(data.currentPrice)}</span>
                            <span className="ts_tag"></span>
                            </div>

                        <span className={styles.discount}>
                            {Math.ceil((1 - data.currentPrice / data.originPrice) * 100)}<span className="font_default" >%</span>OFF
                        </span>
                    </div>
