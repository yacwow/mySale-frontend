  ...
  const buildTrListIfHasDetail = () => {
        ...
        <tr key={index}>
          <td className={styles.center} style={{ verticalAlign: 'middle' }}>
            <input
              ...
              onChange={() => handleAddressChoose(index)}
            />
          </td>
          <td
          ...
          <td className={styles.center} style={{ width: '57%' }}>
            日本, 东京, Chiyoda Ward, Hitotsubashi (1-chome); Takeyama,
            270-1089, 081-1354-5526, 1000003
          </td>
          <td
            style={{
              textAlign: 'center',
          ...
          >
            <NavLink
              ...
              to="https://www.zasale.com/account/order/update-shipping-address/147715"
            >
              内容变更
            </NavLink>
          </td>
    ...
    return (
      <>
        ...
        <div>
          <NavLink
            to="https://www.zasale.com/account/order/update-shipping-address/default"
    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <Form.Item style={{ width: 400, paddingTop: 30 }} name="postcode">
            <div>
