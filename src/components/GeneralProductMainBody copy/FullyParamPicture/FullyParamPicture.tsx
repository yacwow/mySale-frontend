      ...
      <div className={styles.cateItemData}>
        <NavLink to={href} title={title}>
          <p className={styles.omit}>
            {newProduct ? (
              <span className={styles.newSaleLabel}>NEW</span>
            ) : null}
        ...
        {comment ? (
          <p className={styles.comment}>
            <NavLink to={href} title={title}>
              <span
                className={`${styles.reviewsShow} ${
                  styles['star' + comment.commentRate]
                }`}
              ></span>
            </NavLink>
            <NavLink to={comment.commentHref} className={styles.commentNum}>
              レビュー / <b>{comment.commentNum}</b> 件
            </NavLink>
          </p>
        ) : null}
      </div>
