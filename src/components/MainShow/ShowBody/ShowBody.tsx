...
const App: React.FC<Props> = (props) => {
    const { selectNum = 0, showBodyPictureData, tableValue, productMaterial, reviewContext } = props;
    ...
    return (
        <div className={styles.container}>
            <BodyHeader setSelectItem={setSelectItem} commentNumber={reviewContext.comment.length}></BodyHeader>
            {selectItem === 0 ? <ProductDetail productDetailSrc={showBodyPictureData} /> :
                selectItem === 1 ? <ProductSize tableValue={tableValue} productMaterial={productMaterial} /> :
                    selectItem === 2 ? <div>
