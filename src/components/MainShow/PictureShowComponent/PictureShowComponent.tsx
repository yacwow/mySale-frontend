...
const App: React.FC<Props> = (props) => {
    ...
    const { showComponent, discount = false, secondOneHalf = false, deliveriedSrc,
        magnifierPic,setMagnifierPic 
    } = props;
    ...
    const buildPictureList = () => {
        return showComponent.map((item, index: number) => {
            ...
            return (<li key={index} className={index === 0 ? `${styles.active}` : 'notActive'}
    ...
    return (
        <>
            ...
            {magnifierPic ? <div className={`${styles.container} mainShow_pictureShowComponent`}>
                ...
                <div className={styles.right} style={{ position: 'relative' }}>
                    <ReactImageMagnify {
                        ...{
                            ...
                            enlargedImageContainerStyle: { zIndex: 10000000, marginLeft: 30 },
                    ...
                    {discount ? <img src='/img/discount.jpg' style={{ position: 'absolute', bottom: 0, right: 0 }}></img> : null}
                    {secondOneHalf ? <img src='/img/50%discount.webp' style={{ position: 'absolute', top: 0, right: 0 }}></img> : null}
                </div>
            </div >
                : null}
        </>
